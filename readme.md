...
A co-branded card is a retail merchant credit card that is issued in partnership with a specific network processor. For eg: [mada](https://www.mada.com.sa/en). You can create custom type for these cards and can be used like
